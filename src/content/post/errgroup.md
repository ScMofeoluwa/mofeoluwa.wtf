...
description: "Just me trying out error groups"
publishDate: "29 Mar 2024"
tags: ["golang"]
---

Coughs\*, I first learned about error groups about a week ago during an episode of the Go Time podcast [series](https://open.spotify.com/episode/5rx0SSiRSgu6YNF5IS9F7n?si=dd5e0379453d49e9). It's been a while since I've written, so I thought I'd share my thoughts on error groups and wait groups, and why I believe error groups are the better choice for my future projects. Please note that, as of now, error groups are not part of the standard Go library but are included in the Go X subdirectories. Here are some of the current reasons why I like error groups:
